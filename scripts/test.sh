...
mono --debug --profile=log:coverage,covfilter=+[MbedCloudSDK],covfilter=-MbedCloudSDK.Backends,output=int-output.mlpd TestServer/bin/Release/TestServer.exe $API_KEY &
