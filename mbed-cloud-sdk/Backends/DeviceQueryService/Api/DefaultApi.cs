...
namespace device_query_service.Api
{
    ...
    public partial class DefaultApi : IDefaultApi
    {
        ...
        /// <summary>
        /// Create device query &lt;p&gt;The APIs for creating and manipulating device queries.  &lt;/p&gt; &lt;p&gt;Create device query&lt;/p&gt;
        /// </summary>
        /// <exception cref="device_query_service.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="name">The name of the query</param>
        /// <param name="query">The device query</param>
        ...
        /// <summary>
        /// Delete device query &lt;p&gt;The APIs for creating and manipulating device queries.  &lt;/p&gt; &lt;p&gt;Delete device query&lt;/p&gt;
        /// </summary>
        /// <exception cref="device_query_service.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="queryId"></param>
        /// <returns>DeviceQuerySerializer</returns>
        ...
        /// <summary>
        /// List all device queries &lt;p&gt;The APIs for creating and manipulating device queries.  &lt;/p&gt; &lt;p&gt;List all device queries. The result will be paged into pages of 100.&lt;/p&gt;
        /// </summary>
        /// <exception cref="device_query_service.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="description"> (optional)</param>
        /// <param name="createdAt"> (optional)</param>
        ...
        /// <summary>
        /// Update device query fields &lt;p&gt;The APIs for creating and manipulating device queries.  &lt;/p&gt; &lt;p&gt;Update device query fields&lt;/p&gt;
        /// </summary>
        /// <exception cref="device_query_service.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="queryId"></param>
        /// <param name="description">The description of the object (optional)</param>
        ...
        /// <summary>
        /// Retrieve device query &lt;p&gt;The APIs for creating and manipulating device queries.  &lt;/p&gt; &lt;p&gt;Retrieve device query.&lt;/p&gt;
        /// </summary>
        /// <exception cref="device_query_service.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="queryId"></param>
        /// <returns>DeviceQuerySerializer</returns>
        ...
        /// <summary>
        /// Update device query &lt;p&gt;The APIs for creating and manipulating device queries.  &lt;/p&gt; &lt;p&gt;Update device query.&lt;/p&gt;
        /// </summary>
        /// <exception cref="device_query_service.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="queryId"></param>
        /// <param name="name">The name of the query</param>
