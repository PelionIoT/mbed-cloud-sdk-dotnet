...
namespace device_catalog.Api
{
    ...
    public interface IDefaultApi : IApiAccessor
    {
        ...
        /// <param name="hasMore"> (optional)</param>
    ...
    public partial class DefaultApi : IDefaultApi
    {
        ...
        public ApiResponse< DeviceSerializer > DeviceListWithHttpInfo (string _object = null, int? limit = null, bool? hasMore = null, List<string> data = null, string order = null, string after = null, int? totalCount = null)
        {
            ...
            if (hasMore != null) localVarQueryParams.Add("has_more", Configuration.ApiClient.ParameterToString(hasMore)); // query parameter
            ...
            if (totalCount != null) localVarQueryParams.Add("total_count", Configuration.ApiClient.ParameterToString(totalCount)); // query parameter
