...
namespace iam.Model
{
    ...
    public partial class UserInfoRespList :  IEquatable<UserInfoRespList>, IValidatableObject
    {
        ...
        public UserInfoRespList(string After = default(string), List<UserInfoResp> Data = default(List<UserInfoResp>), bool? HasMore = default(bool?), int? Limit = default(int?), ObjectEnum? _Object = default(ObjectEnum?), OrderEnum? Order = default(OrderEnum?), int? TotalCount = default(int?))
        {
