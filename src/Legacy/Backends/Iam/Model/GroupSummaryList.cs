...
namespace iam.Model
{
    ...
    public partial class GroupSummaryList :  IEquatable<GroupSummaryList>, IValidatableObject
    {
        ...
        public GroupSummaryList(string After = default(string), List<GroupSummary> Data = default(List<GroupSummary>), bool? HasMore = default(bool?), int? Limit = default(int?), ObjectEnum? _Object = default(ObjectEnum?), OrderEnum? Order = default(OrderEnum?), int? TotalCount = default(int?))
        {
