...
namespace device_directory.Model
{
    ...
    public partial class DeviceQueryPatchRequest :  IEquatable<DeviceQueryPatchRequest>, IValidatableObject
    {
        ...
        public DeviceQueryPatchRequest(string Name = default(string), string Query = default(string))
        {
            this.Name = Name;
            this.Query = Query;
        }
        ...
        {
            return this.Equals(input as DeviceQueryPatchRequest);
        }

        /// <summary>
        /// Returns true if DeviceQueryPatchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceQueryPatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceQueryPatchRequest input)
        {
            if (input == null)
                return false;
