...
namespace update_service.Model
{
    ...
    public partial class CampaignDeviceMetadataPage :  IEquatable<CampaignDeviceMetadataPage>, IValidatableObject
    {
        ...
        /// <param name="HasMore">A flag indicating whether there are more results.</param>
        /// <param name="Limit">The number of results to return, (range: 2-1000), or equals to total_count.</param>
        /// <param name="_Object">The entity name: always &#39;list&#39;.</param>
        /// <param name="Order">The order of the records to return. Acceptable values: ASC, DESC. Default: ASC.</param>
        /// <param name="TotalCount">The total number or records, if requested. It may be returned also for small lists..</param>
        public CampaignDeviceMetadataPage(string After = default(string), List<CampaignDeviceMetadata> Data = default(List<CampaignDeviceMetadata>), bool? HasMore = default(bool?), int? Limit = default(int?), string _Object = default(string), OrderEnum? Order = default(OrderEnum?), int? TotalCount = default(int?))
        {
            this.After = After;
            this.Data = Data;
        ...
        /// </summary>
        /// <value>A flag indicating whether there are more results</value>
        ...
        /// </summary>
        /// <value>The entity name: always &#39;list&#39;</value>
        ...
        /// </summary>
        /// <value>The total number or records, if requested. It may be returned also for small lists.</value>
