...
namespace update_service.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FirmwareManifestEqNeqFilter :  IEquatable<FirmwareManifestEqNeqFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FirmwareManifestEqNeqFilter" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as FirmwareManifestEqNeqFilter);
        }

        /// <summary>
        /// Returns true if FirmwareManifestEqNeqFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of FirmwareManifestEqNeqFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FirmwareManifestEqNeqFilter input)
        {
            if (input == null)
                return false;
