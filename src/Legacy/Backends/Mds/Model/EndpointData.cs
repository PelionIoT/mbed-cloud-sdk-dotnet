...
namespace mds.Model
{
    ...
    public partial class EndpointData :  IEquatable<EndpointData>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Ep">Unique Device Management device ID..</param>
        ...
        public EndpointData(string Ep = default(string), string Ept = default(string), string OriginalEp = default(string), bool? Q = default(bool?), List<ResourcesData> Resources = default(List<ResourcesData>))
        {
            this.Ep = Ep;
            this.Ept = Ept;
        ...
        /// </summary>
        /// <value>Unique Device Management device ID.</value>
