    ...
    public class UserInvitationRepository : Repository, IUserInvitationRepository
    {
        ...
        public PaginatedResponse<IUserInvitationListOptions, UserInvitation> List(IUserInvitationListOptions options = null)
        {
            try
            {
                ...
                Func<IUserInvitationListOptions, Task<ResponsePage<UserInvitation>>> paginatedFunc = async (IUserInvitationListOptions _options) => { var queryParams = new Dictionary<string, object> { { "after", _options.After }, { "limit", _options.Limit }, { "order", _options.Order }, { "login_profile__eq", _options.Filter.GetEncodedValue("loginProfile","$eq") }, }; return await Client.CallApi<ResponsePage<UserInvitation>>(path: "/v3/user-invitations", queryParams: queryParams, method: HttpMethods.GET); };
