    ...
    public class TrustedCertificateRepository : Repository, ITrustedCertificateRepository
    {
        ...
        public PaginatedResponse<ITrustedCertificateListOptions, TrustedCertificate> List(ITrustedCertificateListOptions options = null)
        {
            try
            {
                ...
                Func<ITrustedCertificateListOptions, Task<ResponsePage<TrustedCertificate>>> paginatedFunc = async (ITrustedCertificateListOptions _options) => { var queryParams = new Dictionary<string, object> { { "after", _options.After }, { "include", _options.Include }, { "limit", _options.Limit }, { "order", _options.Order }, { "name__eq", _options.Filter.GetEncodedValue("name") }, { "service__eq", _options.Filter.GetEncodedValue("service") }, { "expire__eq", _options.Filter.GetEncodedValue("expire") }, { "device_execution_mode__eq", _options.Filter.GetEncodedValue("deviceExecutionMode") }, { "device_execution_mode__neq", _options.Filter.GetEncodedValue("deviceExecutionMode") }, { "owner__eq", _options.Filter.GetEncodedValue("owner") }, { "enrollment_mode__eq", _options.Filter.GetEncodedValue("enrollmentMode") }, { "status__eq", _options.Filter.GetEncodedValue("status") }, { "issuer__like", _options.Filter.GetEncodedValue("issuer") }, { "subject__like", _options.Filter.GetEncodedValue("subject") }, { "valid__eq", _options.Filter.GetEncodedValue("valid") }, }; return await Client.CallApi<ResponsePage<TrustedCertificate>>(path: "/v3/trusted-certificates", queryParams: queryParams, method: HttpMethods.GET); };
