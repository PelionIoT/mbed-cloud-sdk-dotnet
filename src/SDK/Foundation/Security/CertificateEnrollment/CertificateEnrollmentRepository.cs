    ...
    public class CertificateEnrollmentRepository : Repository, ICertificateEnrollmentRepository
    {
        ...
        public PaginatedResponse<ICertificateEnrollmentListOptions, CertificateEnrollment> List(ICertificateEnrollmentListOptions options = null)
        {
            try
            {
                ...
                Func<ICertificateEnrollmentListOptions, Task<ResponsePage<CertificateEnrollment>>> paginatedFunc = async (ICertificateEnrollmentListOptions _options) => { var queryParams = new Dictionary<string, object> { { "after", _options.After }, { "include", _options.Include }, { "limit", _options.Limit }, { "order", _options.Order }, { "device_id__eq", _options.Filter.GetEncodedValue("deviceId") }, { "certificate_name__eq", _options.Filter.GetEncodedValue("certificateName") }, { "enroll_status__neq", _options.Filter.GetEncodedValue("enrollStatus") }, { "enroll_status__eq", _options.Filter.GetEncodedValue("enrollStatus") }, { "enroll_result__neq", _options.Filter.GetEncodedValue("enrollResult") }, { "enroll_result__eq", _options.Filter.GetEncodedValue("enrollResult") }, { "created_at__lte", _options.Filter.GetEncodedValue("createdAt") }, { "created_at__gte", _options.Filter.GetEncodedValue("createdAt") }, { "updated_at__lte", _options.Filter.GetEncodedValue("updatedAt") }, { "updated_at__gte", _options.Filter.GetEncodedValue("updatedAt") }, }; return await Client.CallApi<ResponsePage<CertificateEnrollment>>(path: "/v3/certificate-enrollments", queryParams: queryParams, method: HttpMethods.GET); };
