...
- API version: 0.1
- SDK version: 1.0.0
- Build date: 2016-12-02T09:30:41.133Z
...
namespace Example
{
    public class Example
    {
        public void main()
        {
            ...
            try
            {
                DeviceListResp result = apiInstance.DeviceCreate(mechanism, provisionKey, accountId, autoUpdate, bootstrappedTimestamp, createdAt, customAttributes, deployedState, deployment, description, deviceClass, deviceId, etag, id, manifest, mechanismUrl, name, _object, serialNumber, state, trustClass, trustLevel, updatedAt, vendorId);
