...
namespace device_catalog.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeviceSerializer :  IEquatable<DeviceSerializer>, IValidatableObject
    {
        /// <summary>
        ...
        protected DeviceSerializer() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceSerializer" /> class.
        /// </summary>
        /// <param name="BootstrappedTimestamp">Timestamp of manifest creation. Used in manifest version checks. (required).</param>
        ...
        public DeviceSerializer(DateTime? BootstrappedTimestamp = default(DateTime?), DateTime? UpdatedAt = default(DateTime?), string CustomAttributes = default(string), string DeviceClass = default(string), string Id = default(string), string Description = default(string), bool? AutoUpdate = default(bool?), MechanismEnum? Mechanism = default(MechanismEnum?), StateEnum? State = default(StateEnum?), DateTime? Etag = default(DateTime?), string ProvisionKey = default(string), string SerialNumber = default(string), string VendorId = default(string), string AccountId = default(string), DeployedStateEnum? DeployedState = default(DeployedStateEnum?), string _Object = default(string), long? TrustClass = default(long?), string Deployment = default(string), string MechanismUrl = default(string), long? TrustLevel = default(long?), string DeviceId = default(string), string Name = default(string), DateTime? CreatedAt = default(DateTime?), string Manifest = default(string))
        {
        ...
        /// </summary>
        /// <value>Timestamp of manifest creation. Used in manifest version checks.</value>
