...
namespace device_catalog.
{
    ...
    public partial class DeviceDetail :  IEquatable<DeviceDetail>, IValidatableObject
    {
        ...
        { 
            ...
            if(this.TrustClass > (long?)2.147483647E9)
            {
                yield return new ValidationResult("Invalid value for TrustClass, must be a value less than or equal to 2.147483647E9.", new [] { "TrustClass" });
            }

            // TrustClass (long?) minimum
            if(this.TrustClass < (long?)-2.147483648E9)
            {
                yield return new ValidationResult("Invalid value for TrustClass, must be a value greater than or equal to -2.147483648E9.", new [] { "TrustClass" });
            }

            // TrustLevel (long?) maximum
            if(this.TrustLevel > (long?)2.147483647E9)
            {
                yield return new ValidationResult("Invalid value for TrustLevel, must be a value less than or equal to 2.147483647E9.", new [] { "TrustLevel" });
            }

            // TrustLevel (long?) minimum
            if(this.TrustLevel < (long?)-2.147483648E9)
            {
                yield return new ValidationResult("Invalid value for TrustLevel, must be a value greater than or equal to -2.147483648E9.", new [] { "TrustLevel" });
            }
