...
namespace device_catalog.Model
{
    ...
    public partial class DeviceDataPutRequest :  IEquatable<DeviceDataPutRequest>, IValidatableObject
    {
        ...
        /// <param name="DeployedState">DeployedState (required).</param>
        /// <param name="FirmwareChecksum">FirmwareChecksum (required).</param>
        /// <param name="AutoUpdate">AutoUpdate (required).</param>
        /// <param name="Mechanism">Mechanism (required).</param>
        /// <param name="DeviceClass">DeviceClass (required).</param>
        /// <param name="TrustLevel">TrustLevel (required).</param>
        /// <param name="CustomAttributes">CustomAttributes (required).</param>
        /// <param name="Manifest">Manifest (required).</param>
        /// <param name="TrustClass">TrustClass (required).</param>
        ...
        /// <param name="MechanismUrl">MechanismUrl (required).</param>
