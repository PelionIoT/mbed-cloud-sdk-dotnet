...
namespace developer_certificate.Model
{
    ...
    public partial class DeveloperCertificate :  IEquatable<DeveloperCertificate>, IValidatableObject
    {
        ...
        public DeveloperCertificate(string CreatedAt = default(string), string Etag = default(string), string PubKey = default(string), string _Object = default(string), string Id = default(string))
        {
