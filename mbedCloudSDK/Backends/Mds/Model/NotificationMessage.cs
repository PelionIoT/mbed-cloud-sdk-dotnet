...
namespace mds.Model
{
    ...
    public partial class NotificationMessage :  IEquatable<NotificationMessage>, IValidatableObject
    {
        ...
        public NotificationMessage(List<AsyncIDResponse> AsyncResponses = default(List<AsyncIDResponse>), List<string> DeRegistrations = default(List<string>), List<EndpointData> RegUpdates = default(List<EndpointData>), List<EndpointData> Registrations = default(List<EndpointData>), List<NotificationData> Notifications = default(List<NotificationData>), List<string> RegistrationsExpired = default(List<string>))
        {
