...
{
    /// <summary>
    /// WriteCampaignDeviceMetadataSerializer
    /// </summary>
    [DataContract]
    public partial class WriteCampaignDeviceMetadataSerializer :  IEquatable<WriteCampaignDeviceMetadataSerializer>, IValidatableObject
    {
        /// <summary>
        ...
        protected WriteCampaignDeviceMetadataSerializer() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WriteCampaignDeviceMetadataSerializer" /> class.
        /// </summary>
        ...
        public WriteCampaignDeviceMetadataSerializer(string Description = default(string), string Campaign = default(string), string _Object = default(string), string Mechanism = default(string), string Name = default(string), string MechanismUrl = default(string), DeploymentStateEnum? DeploymentState = default(DeploymentStateEnum?), string DeviceId = default(string))
        {
