...
namespace device_query_service.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeviceQueryResp :  IEquatable<DeviceQueryResp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceQueryResp" /> class.
        /// </summary>
        ...
        public DeviceQueryResp(string _Object = default(string), bool? HasMore = default(bool?), int? TotalCount = default(int?), string After = default(string), int? Limit = default(int?), List<DeviceQueryDetail> Data = default(List<DeviceQueryDetail>), string Order = default(string))
        {
        ...
        public List<DeviceQueryDetail> Data { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceQueryResp {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DeviceQueryResp);
        }

        /// <summary>
        /// Returns true if DeviceQueryResp instances are equal
        /// </summary>
        /// <param name="other">Instance of DeviceQueryResp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceQueryResp other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
