...
namespace provisioning_certificate.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProvisioningCertificate :  IEquatable<ProvisioningCertificate>, IValidatableObject
    {
        /// <summary>
        ...
        public ProvisioningCertificate(string CreatedAt = default(string), string ProvisioningContextCertificate = default(string), string Id = default(string), string Etag = default(string), string _Object = default(string))
        {
