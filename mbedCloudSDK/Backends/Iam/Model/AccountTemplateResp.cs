...
namespace iam.Model
{
    ...
    public partial class AccountTemplateResp :  IEquatable<AccountTemplateResp>, IValidatableObject
    {
        ...
        public AccountTemplateResp(Dictionary<string, string> Limits = default(Dictionary<string, string>), string Name = default(string), string Parent = default(string), string CreatedAt = default(string), ObjectEnum? _Object = default(ObjectEnum?), string Etag = default(string), long? CreationTimeMillis = default(long?), string Id = default(string), List<Policy> Resources = default(List<Policy>), string Description = default(string))
        {
