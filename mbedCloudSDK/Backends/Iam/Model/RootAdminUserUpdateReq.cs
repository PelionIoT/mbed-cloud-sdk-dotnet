...
namespace iam.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RootAdminUserUpdateReq :  IEquatable<RootAdminUserUpdateReq>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RootAdminUserUpdateReq" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RootAdminUserUpdateReq() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RootAdminUserUpdateReq" /> class.
        /// </summary>
        ...
        public RootAdminUserUpdateReq(string Username = default(string), string PhoneNumber = default(string), bool? IsMarketingAccepted = default(bool?), bool? IsGtcAccepted = default(bool?), string Status = default(string), string FullName = default(string), string Address = default(string), string Password = default(string), string Email = default(string))
        {
            // to ensure "Username" is required (not null)
            if (Username == null)
            {
                throw new InvalidDataException("Username is a required property for RootAdminUserUpdateReq and cannot be null");
            }
            else
            {
            ...
            if (Email == null)
            {
                throw new InvalidDataException("Email is a required property for RootAdminUserUpdateReq and cannot be null");
            }
            else
            {
                this.Email = Email;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RootAdminUserUpdateReq {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RootAdminUserUpdateReq);
        }

        /// <summary>
        /// Returns true if RootAdminUserUpdateReq instances are equal
        /// </summary>
        /// <param name="other">Instance of RootAdminUserUpdateReq to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RootAdminUserUpdateReq other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
