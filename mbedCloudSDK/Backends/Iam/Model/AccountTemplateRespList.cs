...
namespace iam.Model
{
    ...
    public partial class AccountTemplateRespList :  IEquatable<AccountTemplateRespList>, IValidatableObject
    {
        ...
        public AccountTemplateRespList(string After = default(string), bool? HasMore = default(bool?), int? TotalCount = default(int?), ObjectEnum? _Object = default(ObjectEnum?), int? Limit = default(int?), List<AccountTemplateResp> Data = default(List<AccountTemplateResp>), OrderEnum? Order = default(OrderEnum?))
        {
