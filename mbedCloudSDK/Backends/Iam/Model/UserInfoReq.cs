...
namespace iam.Model
{
    ...
    public partial class UserInfoReq :  IEquatable<UserInfoReq>, IValidatableObject
    {
        ...
        public UserInfoReq(List<string> Groups = default(List<string>), string Username = default(string), bool? IsMarketingAccepted = default(bool?), bool? IsGtcAccepted = default(bool?), string FullName = default(string), string Address = default(string), string Password = default(string), string PhoneNumber = default(string), string Email = default(string))
        {
