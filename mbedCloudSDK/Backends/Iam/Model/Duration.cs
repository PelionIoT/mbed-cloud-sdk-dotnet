...
namespace iam.Model
{
    ...
    public partial class Duration :  IEquatable<Duration>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Duration" /> class.
        /// </summary>
        /// <param name="_Duration">The duration to determine how old entries should be deleted in the garbage collection. (required).</param>
        ...
        /// </summary>
        /// <value>The duration to determine how old entries should be deleted in the garbage collection.</value>
