...
namespace iam.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RootAdminUpdateReq :  IEquatable<RootAdminUpdateReq>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RootAdminUpdateReq" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RootAdminUpdateReq() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RootAdminUpdateReq" /> class.
        /// </summary>
        ...
        public RootAdminUpdateReq(string Username = default(string), string PhoneNumber = default(string), bool? IsMarketingAccepted = false, bool? IsGtcAccepted = false, string Status = default(string), string FullName = default(string), string Address = default(string), string Password = default(string), string Email = default(string))
        {
            // to ensure "Username" is required (not null)
            if (Username == null)
            {
                throw new InvalidDataException("Username is a required property for RootAdminUpdateReq and cannot be null");
            }
            else
            {
            ...
            if (Email == null)
            {
                throw new InvalidDataException("Email is a required property for RootAdminUpdateReq and cannot be null");
            }
            else
            {
                this.Email = Email;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RootAdminUpdateReq {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RootAdminUpdateReq);
        }

        /// <summary>
        /// Returns true if RootAdminUpdateReq instances are equal
        /// </summary>
        /// <param name="other">Instance of RootAdminUpdateReq to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RootAdminUpdateReq other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
