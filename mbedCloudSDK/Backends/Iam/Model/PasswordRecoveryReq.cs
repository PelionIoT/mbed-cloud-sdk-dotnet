...
namespace iam.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PasswordRecoveryReq :  IEquatable<PasswordRecoveryReq>, IValidatableObject
    {
        /// <summary>
        ...
        public PasswordRecoveryReq(string Password = default(string), string Hash = default(string))
        {
