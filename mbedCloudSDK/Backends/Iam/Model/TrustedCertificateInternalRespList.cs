...
namespace iam.Model
{
    ...
    public partial class TrustedCertificateInternalRespList :  IEquatable<TrustedCertificateInternalRespList>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TrustedCertificateInternalRespList);
        }

        /// <summary>
        /// Returns true if TrustedCertificateInternalRespList instances are equal
        /// </summary>
        /// <param name="other">Instance of TrustedCertificateInternalRespList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrustedCertificateInternalRespList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
