...
namespace iam.Model
{
    ...
    public partial class AccountCreationReq :  IEquatable<AccountCreationReq>, IValidatableObject
    {
        ...
        public AccountCreationReq(string AddressLine2 = default(string), string City = default(string), string AddressLine1 = default(string), string DisplayName = default(string), string Country = default(string), string Company = default(string), string TemplateId = default(string), string State = default(string), string Contact = default(string), string PostalCode = default(string), string AdminPassword = default(string), string AdminName = default(string), string ParentID = default(string), string Tier = default(string), string AdminEmail = default(string), string PhoneNumber = default(string), string Email = default(string), List<string> Aliases = default(List<string>))
        {
