...
namespace iam.Model
{
    ...
    public partial class TrustedCertificateInternalResp :  IEquatable<TrustedCertificateInternalResp>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="TrustedCertificateInternalResp" /> class.
        /// </summary>
        /// <param name="PrivateKey">Private key of the certificate in DER format. (required).</param>
        ...
        public TrustedCertificateInternalResp(string PrivateKey = default(string), string Description = default(string), ServiceEnum? Service = default(ServiceEnum?), int? DeviceExecutionMode = default(int?), string CreatedAt = default(string), ObjectEnum? _Object = default(ObjectEnum?), string Subject = default(string), string AccountId = default(string), string Etag = default(string), string Validity = default(string), long? CreationTimeMillis = default(long?), string Issuer = default(string), string CertData = default(string), string Id = default(string), string Name = default(string))
        {
            ...
            {
                throw new InvalidDataException("DeviceExecutionMode is a required property for TrustedCertificateInternalResp and cannot be null");
            }
            else
            {
            ...
            if (CertData == null)
            {
                throw new InvalidDataException("CertData is a required property for TrustedCertificateInternalResp and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Private key of the certificate in DER format.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TrustedCertificateInternalResp);
        }

        /// <summary>
        /// Returns true if TrustedCertificateInternalResp instances are equal
        /// </summary>
        /// <param name="other">Instance of TrustedCertificateInternalResp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrustedCertificateInternalResp other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
