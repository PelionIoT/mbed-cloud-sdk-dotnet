...
namespace iam.Model
{
    ...
    public partial class AccountInfoList :  IEquatable<AccountInfoList>, IValidatableObject
    {
        ...
        public AccountInfoList(string After = default(string), bool? HasMore = false, int? TotalCount = default(int?), ObjectEnum? _Object = default(ObjectEnum?), int? Limit = default(int?), List<AccountInfo> Data = default(List<AccountInfo>), OrderEnum? Order = default(OrderEnum?))
        {
