...
*DefaultApi* | [**CheckExpiredCertificates**](docs/DefaultApi.md#checkexpiredcertificates) | **POST** /internal/v1/gc/ca-certificates | Check expiring certificates
...
*DefaultApi* | [**GetAllAccountsAllCertificates**](docs/DefaultApi.md#getallaccountsallcertificates) | **GET** /admin/v3/trusted-certificates | Get all accounts all trusted certificates.
*DefaultApi* | [**GetDeveloperCertificate**](docs/DefaultApi.md#getdevelopercertificate) | **GET** /internal/v1/trusted-certificates/{cert-id} | Get developer trusted certificate by ID.
*DefaultApi* | [**GetInternalAllAccountsAllCertificates**](docs/DefaultApi.md#getinternalallaccountsallcertificates) | **GET** /internal/v1/trusted-certificates | Get all accounts all trusted certificates.
...
*RootAdminApi* | [**AdminCreateAccount**](docs/RootAdminApi.md#admincreateaccount) | **POST** /admin/v3/accounts | Create a new account.
*RootAdminApi* | [**AdminDeleteAccount**](docs/RootAdminApi.md#admindeleteaccount) | **DELETE** /admin/v3/accounts/{accountID} | Delete an existing account.
...
*RootAdminApi* | [**DeleteAccountCertificate**](docs/RootAdminApi.md#deleteaccountcertificate) | **DELETE** /v3/accounts/{accountID}/trusted-certificates/{cert-id} | Delete trusted certificate by ID.
...
*RootAdminApi* | [**GetAccountCertificate**](docs/RootAdminApi.md#getaccountcertificate) | **GET** /v3/accounts/{accountID}/trusted-certificates/{cert-id} | Get trusted certificate by ID.
...
*RootAdminApi* | [**GetAdminOptions**](docs/RootAdminApi.md#getadminoptions) | **GET** /admin/v3/iam/features | Get admin options.
...
*RootAdminApi* | [**GetAllAccountCertificates**](docs/RootAdminApi.md#getallaccountcertificates) | **GET** /v3/accounts/{accountID}/trusted-certificates | Get all trusted certificates.
...
*RootAdminApi* | [**GetAllAccountsAllApiKeys**](docs/RootAdminApi.md#getallaccountsallapikeys) | **GET** /admin/v3/api-keys | Get all API keys from all accounts
...
*RootAdminApi* | [**UpdateAccountCertificate**](docs/RootAdminApi.md#updateaccountcertificate) | **PUT** /v3/accounts/{accountID}/trusted-certificates/{cert-id} | Update trusted certificate.
...
## Documentation for Models
 ...
 - [Model.RootAdminUserUpdateReq](docs/RootAdminUserUpdateReq.md)
 - [Model.SubjectList](docs/SubjectList.md)
 - [Model.TrustedCertificateInternalReq](docs/TrustedCertificateInternalReq.md)
