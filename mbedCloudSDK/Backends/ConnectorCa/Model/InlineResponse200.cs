...
namespace connector_ca.Model
{
    ...
    public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="ServerUri">Bootstrap server URI to which the client needs to connect to..</param>
        ...
        public InlineResponse200(string ServerUri = default(string), string ServerCertificate = default(string))
        {
