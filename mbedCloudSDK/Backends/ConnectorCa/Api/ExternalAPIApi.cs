...
namespace connector_ca.Api
{
    ...
    /// </summary>
    public interface IExternalAPIApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ExternalAPIApi : IExternalAPIApi
    {
        private connector_ca.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ExternalAPIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ExternalAPIApi(String basePath)
        {
        ...
        /// <returns></returns>
        public ExternalAPIApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< DeveloperCertificateResponseData > V3DeveloperCertificatesIdGetWithHttpInfo (string id, string authorization)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ExternalAPIApi->V3DeveloperCertificatesIdGet");
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling ExternalAPIApi->V3DeveloperCertificatesIdGet");
        ...
        public ApiResponse< DeveloperCertificateResponseData > V3DeveloperCertificatesPostWithHttpInfo (string authorization, DeveloperCertificateRequestData body)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling ExternalAPIApi->V3DeveloperCertificatesPost");
