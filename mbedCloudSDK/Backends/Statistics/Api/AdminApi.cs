...
namespace statistics.Api
{
    ...
    public partial class AdminApi : IAdminApi
    {
        ...
        public ApiResponse< SuccessfulResponse > V3MetricsGlobalGetWithHttpInfo (string include, string start, string end, string period, string interval, string authorization)
        {
            ...
            if (include == null)
                throw new ApiException(400, "Missing required parameter 'include' when calling AdminApi->V3MetricsGlobalGet");
            // verify the required parameter 'start' is set
            if (start == null)
                throw new ApiException(400, "Missing required parameter 'start' when calling AdminApi->V3MetricsGlobalGet");
            // verify the required parameter 'end' is set
            if (end == null)
                throw new ApiException(400, "Missing required parameter 'end' when calling AdminApi->V3MetricsGlobalGet");
            // verify the required parameter 'period' is set
            if (period == null)
                throw new ApiException(400, "Missing required parameter 'period' when calling AdminApi->V3MetricsGlobalGet");
            // verify the required parameter 'interval' is set
            if (interval == null)
                throw new ApiException(400, "Missing required parameter 'interval' when calling AdminApi->V3MetricsGlobalGet");
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling AdminApi->V3MetricsGlobalGet");
