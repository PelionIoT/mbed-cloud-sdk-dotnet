...
namespace firmware_catalog.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WriteFirmwareManifest :  IEquatable<WriteFirmwareManifest>
    {
        /// <summary>
        ...
        public WriteFirmwareManifest(string Datafile = null, string Description = null, string Name = null)
        {
