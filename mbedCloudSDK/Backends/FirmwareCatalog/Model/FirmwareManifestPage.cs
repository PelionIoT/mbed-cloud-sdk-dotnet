...
namespace firmware_catalog.Model
{
    ...
    public partial class FirmwareManifestPage :  IEquatable<FirmwareManifestPage>, IValidatableObject
    {
        ...
        public FirmwareManifestPage(string _Object = default(string), bool? HasMore = default(bool?), long? TotalCount = default(long?), string After = default(string), long? Limit = default(long?), List<FirmwareManifest> Data = default(List<FirmwareManifest>), string Order = default(string))
        {
