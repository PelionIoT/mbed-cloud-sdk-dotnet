...
namespace firmware_catalog.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WriteFirmwareImage :  IEquatable<WriteFirmwareImage>
    {
        /// <summary>
        ...
        public WriteFirmwareImage(string Datafile = null, string Description = null, string Name = null)
        {
