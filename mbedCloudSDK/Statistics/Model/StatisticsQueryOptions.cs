...
namespace mbedCloudSDK.Statistics.Model
{
    class StatisticsQueryOptions
    {
        ...
        /// <summary>
        /// Period. Fetch data for the period in days, weeks or hours. Sample values: 2h, 3w, 4d. The parameter is not mandatory, if start and end time are specified. 
        /// </summary>
        public string Period { get; set; }

        /// <summary>
        /// Group data by this interval in days, weeks or hours. Sample values: 2h, 3w, 4d. 
        /// </summary>
        public string Interval { get; set; }

        public StatisticsQueryOptions()
        {
            this.Include = "bootstraps_successful, bootstraps_failed, bootstraps_pending, bootstrap_certificate_create, bootstrap_certificate_delete, connector_certificate_create,  connector_certificate_delete, bootstrap_credentials_get, bootstrap_full_credentials_get, connector_credentials_get, connector_full_credentials_get, connector_ca_rest_api_count, connector_ca_rest_api_error_count";
            this.Interval = "1d";
            this.Period = "1m";
        }
    }
