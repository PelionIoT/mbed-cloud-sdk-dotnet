...
namespace Manhasset.Runner
{
    class Program
    {
        ...
        {
            var pathToConfig = "/Users/alelog01/git/mbed-cloud-sdk-dotnet/merged/public/sdk_gen_intermediate.json";
            ...
            // add ref to SDK
            generator.CompilationContainer.AddMetadataReference(typeof(BaseEntity));
            await generator.Run();
