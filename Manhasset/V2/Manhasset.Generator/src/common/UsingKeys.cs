namespace Manhasset.Generator.src.common
{
    public static class UsingKeys
    {
        ...
        public static readonly string SDK_COMMON = "Mbed.Cloud.Foundation.Common";
        ...
        public static readonly string CLIENT = "Mbed.Cloud.Foundation.RestClient";

        public static readonly string SYSTEM_IO = "System.IO";

        public static readonly string ENTITIES = "Mbed.Cloud.Foundation.Entities";
        public static readonly string ENUMS = "Mbed.Cloud.Foundation.Enums";
        public static readonly string HOME = "Mbed.Cloud";
        public static readonly string ListOptions = "Mbed.Cloud.Foundation.ListOptions";
