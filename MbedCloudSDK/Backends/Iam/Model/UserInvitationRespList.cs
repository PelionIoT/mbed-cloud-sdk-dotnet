...
namespace iam.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserInvitationRespList :  IEquatable<UserInvitationRespList>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserInvitationRespList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UserInvitationRespList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserInvitationRespList" /> class.
        /// </summary>
        ...
        public UserInvitationRespList(string After = default(string), List<UserInvitationResp> Data = default(List<UserInvitationResp>), bool? HasMore = default(bool?), int? Limit = default(int?), ObjectEnum? _Object = default(ObjectEnum?), OrderEnum? Order = default(OrderEnum?), int? TotalCount = default(int?))
        {
            // to ensure "Data" is required (not null)
            if (Data == null)
            {
                throw new InvalidDataException("Data is a required property for UserInvitationRespList and cannot be null");
            }
            else
            {
                this.Data = Data;
            ...
            if (HasMore == null)
            {
                throw new InvalidDataException("HasMore is a required property for UserInvitationRespList and cannot be null");
            }
            else
            {
            ...
            if (Limit == null)
            {
                throw new InvalidDataException("Limit is a required property for UserInvitationRespList and cannot be null");
            }
            else
            {
                this.Limit = Limit;
            ...
            if (_Object == null)
            {
                throw new InvalidDataException("_Object is a required property for UserInvitationRespList and cannot be null");
            }
            else
            {
            ...
            if (TotalCount == null)
            {
                throw new InvalidDataException("TotalCount is a required property for UserInvitationRespList and cannot be null");
            }
            else
            {
        ...
        public List<UserInvitationResp> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserInvitationRespList {\n");
        ...
        {
            return this.Equals(input as UserInvitationRespList);
        }

        /// <summary>
        /// Returns true if UserInvitationRespList instances are equal
        /// </summary>
        /// <param name="input">Instance of UserInvitationRespList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserInvitationRespList input)
        {
            if (input == null)
                return false;
