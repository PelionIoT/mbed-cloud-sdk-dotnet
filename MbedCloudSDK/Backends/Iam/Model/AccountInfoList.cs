...
namespace iam.Model
{
    ...
    public partial class AccountInfoList :  IEquatable<AccountInfoList>, IValidatableObject
    {
        ...
        public AccountInfoList(string After = default(string), List<AccountInfo> Data = default(List<AccountInfo>), bool? HasMore = default(bool?), int? Limit = default(int?), ObjectEnum? _Object = default(ObjectEnum?), OrderEnum? Order = default(OrderEnum?), int? TotalCount = default(int?))
        {
