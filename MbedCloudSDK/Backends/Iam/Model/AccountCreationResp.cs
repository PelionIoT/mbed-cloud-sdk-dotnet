...
namespace iam.Model
{
    ...
    public partial class AccountCreationResp :  IEquatable<AccountCreationResp>, IValidatableObject
    {
        ...
        public AccountCreationResp(string EndMarket = default(string), string AdminId = default(string), string Email = default(string), string AdminName = default(string), string PostalCode = default(string), string Id = default(string), List<string> Aliases = default(List<string>), string AddressLine2 = default(string), string City = default(string), string AddressLine1 = default(string), string DisplayName = default(string), string State = default(string), string AdminPassword = default(string), string ContractNumber = default(string), string PhoneNumber = default(string), string Company = default(string), string AdminKey = default(string), string AdminFullName = default(string), string Country = default(string), string CustomerNumber = default(string), string Contact = default(string), string AdminEmail = default(string))
        {
