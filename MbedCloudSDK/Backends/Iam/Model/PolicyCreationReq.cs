...
namespace iam.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PolicyCreationReq :  IEquatable<PolicyCreationReq>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PolicyCreationReq" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PolicyCreationReq() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PolicyCreationReq" /> class.
        /// </summary>
        /// <param name="Status">The status of this policy..</param>
        ...
        /// <param name="Name">The name of this policy, must be unique and not longer than 100 character. (required).</param>
        /// <param name="ErrorMessage">Custom error message returned when this policy matches with not allowed result..</param>
        /// <param name="NotResources">List of not_resources in urn:mbed-cloud:{resource-type}:{resource-name} format, not more than 100..</param>
        /// <param name="Actions">List of actions as key-pairs of &#39;{action}&#39;: &#39;true&#39; or &#39;false&#39;, not more than 100. For enabling all actions use { &#39;*&#39;: true }..</param>
        /// <param name="NotConditions">List of not_conditions in urn:mbed-cloud:{resource-type}:{resource-name} format, not more than 100..</param>
        ...
        /// <param name="Users">List of user IDs this policy is attached to, not more than 100..</param>
        /// <param name="Groups">List of group IDs this policy is attached to, not more than 100..</param>
        /// <param name="Tag">Policy tag that can be used for various purposes to be able to distinguish between policies. Not longer than 100 characters..</param>
        /// <param name="NotActions">List of not_actions, not more than 100..</param>
        /// <param name="Apikeys">List of API key IDs this policy is attached to, not more than 100..</param>
        /// <param name="Conditions">List of conditions in urn:mbed-cloud:{resource-type}:{resource-name} format, not more than 100..</param>
        /// <param name="Resources">List of resources in urn:mbed-cloud:{resource-type}:{resource-name} format, not more than 100..</param>
        /// <param name="Description">The description of this policy, not longer than 500 character..</param>
        public PolicyCreationReq(StatusEnum? Status = default(StatusEnum?), DateTime? ValidUntil = default(DateTime?), int? GrantExpiresIn = default(int?), string Name = default(string), string ErrorMessage = default(string), List<string> NotResources = default(List<string>), Dictionary<string, bool?> Actions = default(Dictionary<string, bool?>), List<string> NotConditions = default(List<string>), DateTime? ValidFrom = default(DateTime?), List<string> Users = default(List<string>), List<string> Groups = default(List<string>), string Tag = default(string), List<string> NotActions = default(List<string>), List<string> Apikeys = default(List<string>), List<string> Conditions = default(List<string>), List<string> Resources = default(List<string>), string Description = default(string))
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for PolicyCreationReq and cannot be null");
            }
            else
            {
                this.Name = Name;
        ...
        /// </summary>
        /// <value>The name of this policy, must be unique and not longer than 100 character.</value>
        ...
        /// </summary>
        /// <value>List of not_resources in urn:mbed-cloud:{resource-type}:{resource-name} format, not more than 100.</value>
        ...
        /// </summary>
        /// <value>List of actions as key-pairs of &#39;{action}&#39;: &#39;true&#39; or &#39;false&#39;, not more than 100. For enabling all actions use { &#39;*&#39;: true }.</value>
        ...
        /// </summary>
        /// <value>List of not_conditions in urn:mbed-cloud:{resource-type}:{resource-name} format, not more than 100.</value>
        ...
        /// </summary>
        /// <value>List of user IDs this policy is attached to, not more than 100.</value>
        ...
        /// </summary>
        /// <value>List of group IDs this policy is attached to, not more than 100.</value>
        ...
        /// </summary>
        /// <value>Policy tag that can be used for various purposes to be able to distinguish between policies. Not longer than 100 characters.</value>
        ...
        /// </summary>
        /// <value>List of not_actions, not more than 100.</value>
        ...
        /// </summary>
        /// <value>List of API key IDs this policy is attached to, not more than 100.</value>
        ...
        /// </summary>
        /// <value>List of conditions in urn:mbed-cloud:{resource-type}:{resource-name} format, not more than 100.</value>
        ...
        /// </summary>
        /// <value>List of resources in urn:mbed-cloud:{resource-type}:{resource-name} format, not more than 100.</value>
        ...
        /// </summary>
        /// <value>The description of this policy, not longer than 500 character.</value>
        ...
        {
            return this.Equals(input as PolicyCreationReq);
        }

        /// <summary>
        /// Returns true if PolicyCreationReq instances are equal
        /// </summary>
        /// <param name="input">Instance of PolicyCreationReq to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PolicyCreationReq input)
        {
            if (input == null)
                return false;
