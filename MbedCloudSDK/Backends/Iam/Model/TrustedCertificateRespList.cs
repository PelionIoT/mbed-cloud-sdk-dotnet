...
namespace iam.Model
{
    ...
    public partial class TrustedCertificateRespList :  IEquatable<TrustedCertificateRespList>, IValidatableObject
    {
        ...
        public TrustedCertificateRespList(string After = default(string), bool? HasMore = default(bool?), int? TotalCount = default(int?), ObjectEnum? _Object = default(ObjectEnum?), int? Limit = default(int?), List<TrustedCertificateResp> Data = default(List<TrustedCertificateResp>), OrderEnum? Order = default(OrderEnum?))
        {
        ...
        {
            return this.Equals(input as TrustedCertificateRespList);
        }

        /// <summary>
        /// Returns true if TrustedCertificateRespList instances are equal
        /// </summary>
        /// <param name="input">Instance of TrustedCertificateRespList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrustedCertificateRespList input)
        {
            if (input == null)
                return false;
