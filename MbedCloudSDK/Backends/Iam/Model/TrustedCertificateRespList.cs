...
namespace iam.Model
{
    ...
    public partial class TrustedCertificateRespList :  IEquatable<TrustedCertificateRespList>, IValidatableObject
    {
        ...
        public TrustedCertificateRespList(string After = default(string), List<TrustedCertificateResp> Data = default(List<TrustedCertificateResp>), bool? HasMore = default(bool?), int? Limit = default(int?), ObjectEnum? _Object = default(ObjectEnum?), OrderEnum? Order = default(OrderEnum?), int? TotalCount = default(int?))
        {
