...
namespace mds.Api
{
    ...
    public interface IDeviceRequestsApi : IApiAccessor
    {
        ...
        /// <returns></returns>
        void V2DeviceRequestsDeviceIdasyncIdasyncIdPost (string deviceId, string asyncId, DeviceRequest body);
        ...
        ApiResponse<Object> V2DeviceRequestsDeviceIdasyncIdasyncIdPostWithHttpInfo (string deviceId, string asyncId, DeviceRequest body);
        ...
        System.Threading.Tasks.Task V2DeviceRequestsDeviceIdasyncIdasyncIdPostAsync (string deviceId, string asyncId, DeviceRequest body);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> V2DeviceRequestsDeviceIdasyncIdasyncIdPostAsyncWithHttpInfo (string deviceId, string asyncId, DeviceRequest body);
    ...
    public partial class DeviceRequestsApi : IDeviceRequestsApi
    {
        ...
        /// <param name="body">Device request to send.</param>
        /// <returns></returns>
        public void V2DeviceRequestsDeviceIdasyncIdasyncIdPost (string deviceId, string asyncId, DeviceRequest body)
        {
             V2DeviceRequestsDeviceIdasyncIdasyncIdPostWithHttpInfo(deviceId, asyncId, body);
        }
        ...
        /// <param name="body">Device request to send.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> V2DeviceRequestsDeviceIdasyncIdasyncIdPostWithHttpInfo (string deviceId, string asyncId, DeviceRequest body)
        {
            // verify the required parameter 'deviceId' is set
            if (deviceId == null)
                throw new ApiException(400, "Missing required parameter 'deviceId' when calling DeviceRequestsApi->V2DeviceRequestsDeviceIdasyncIdasyncIdPost");
            // verify the required parameter 'asyncId' is set
            if (asyncId == null)
                throw new ApiException(400, "Missing required parameter 'asyncId' when calling DeviceRequestsApi->V2DeviceRequestsDeviceIdasyncIdasyncIdPost");
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling DeviceRequestsApi->V2DeviceRequestsDeviceIdasyncIdasyncIdPost");

            var localVarPath = "/v2/device-requests/{deviceId}?async-id={asyncId}";
            ...
            if (asyncId != null) localVarPathParams.Add("asyncId", Configuration.ApiClient.ParameterToString(asyncId)); // path parameter
            ...
            {
                Exception exception = ExceptionFactory("V2DeviceRequestsDeviceIdasyncIdasyncIdPost", localVarResponse);
        ...
        /// <param name="body">Device request to send.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task V2DeviceRequestsDeviceIdasyncIdasyncIdPostAsync (string deviceId, string asyncId, DeviceRequest body)
        {
             await V2DeviceRequestsDeviceIdasyncIdasyncIdPostAsyncWithHttpInfo(deviceId, asyncId, body);
        ...
        /// <param name="body">Device request to send.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> V2DeviceRequestsDeviceIdasyncIdasyncIdPostAsyncWithHttpInfo (string deviceId, string asyncId, DeviceRequest body)
        {
            // verify the required parameter 'deviceId' is set
            if (deviceId == null)
                throw new ApiException(400, "Missing required parameter 'deviceId' when calling DeviceRequestsApi->V2DeviceRequestsDeviceIdasyncIdasyncIdPost");
