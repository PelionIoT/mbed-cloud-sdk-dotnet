...
namespace mds.Model
{
    ...
    public partial class Endpoint :  IEquatable<Endpoint>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Name">Unique Device Management Device ID representing the endpoint..</param>
        /// <param name="Q">Determines whether the device is in queue mode. &lt;br/&gt;&lt;br/&gt;&lt;b&gt;Queue mode&lt;/b&gt;&lt;br/&gt; When an endpoint is in queue mode, messages sent to the endpoint do not wake up the physical device. The messages are queued and delivered when the device wakes up and connects to Device Management Connect itself. You can also use the queue mode when the device is behind a NAT and cannot be reached directly by Device Management Connect. .</param>
        ...
        /// </summary>
        /// <value>Unique Device Management Device ID representing the endpoint.</value>
