...
namespace iam.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserUpdateResp :  IEquatable<UserUpdateResp>
    {
        /// <summary>
        ...
        public UserUpdateResp(string Username = default(string), List<LoginHistory> LoginHistory = default(List<LoginHistory>), long? CreationTime = default(long?), string FullName = default(string), string Id = default(string), long? LastLoginTime = default(long?), bool? IsGtcAccepted = default(bool?), string Etag = default(string), bool? IsMarketingAccepted = default(bool?), string PhoneNumber = default(string), string Email = default(string), StatusEnum? Status = default(StatusEnum?), string AccountId = default(string), List<string> TotpScratchCodes = default(List<string>), ObjectEnum? _Object = default(ObjectEnum?), List<string> Groups = default(List<string>), string Address = default(string), string TotpSecret = default(string), string Password = default(string), bool? EmailVerified = default(bool?), DateTime? CreatedAt = default(DateTime?), bool? IsTotpEnabled = default(bool?), long? PasswordChangedTime = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserUpdateResp);
        }

        /// <summary>
        /// Returns true if UserUpdateResp instances are equal
        /// </summary>
        /// <param name="other">Instance of UserUpdateResp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserUpdateResp other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.TotpSecret == other.TotpSecret ||
                    this.TotpSecret != null &&
                    this.TotpSecret.Equals(other.TotpSecret)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TotpSecret != null)
                    hash = hash * 59 + this.TotpSecret.GetHashCode();
