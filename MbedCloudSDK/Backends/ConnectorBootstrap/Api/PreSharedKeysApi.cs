...
namespace connector_bootstrap.Api
{
    ...
    public partial class PreSharedKeysApi : IPreSharedKeysApi
    {
        ...
        /// <summary>
        /// Upload a pre-shared key to Mbed Cloud. Upload a pre-shared key (PSK) for an endpoint to allow it to bootstrap. The existing key will not be overwritten but needs to be deleted first in case of re-setting PSK for an endpoint.  **Note**: The PSK APIs are available only to accounts that have this feature enabled.  &#x60;&#x60;&#x60; Example payloads: {\&quot;endpoint_name\&quot;: \&quot;myEndpoint\&quot;, \&quot;secret_hex\&quot;: \&quot;4a4a4a4a4a4a4a4a4a4a4a4a4a4a4a4a\&quot; } {\&quot;endpoint_name\&quot;: \&quot;myEndpoint\&quot;, \&quot;secret_hex\&quot;: \&quot;0x4a4a4a4a4a4a4a4a4a4a4a4a4a4a4a4a\&quot; } &#x60;&#x60;&#x60; 
        /// </summary>
        /// <exception cref="connector_bootstrap.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">Pre-shared key to be uploaded.</param>
        /// <returns></returns>
