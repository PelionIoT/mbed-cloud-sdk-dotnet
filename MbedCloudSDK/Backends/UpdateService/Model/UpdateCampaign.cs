...
namespace update_service.Model
{
    ...
    public partial class UpdateCampaign :  IEquatable<UpdateCampaign>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>An indication to the condition of the campaign.</value>
        ...
        /// </summary>
        /// <value>An indication to the condition of the campaign.</value>
        [DataMember(Name="health_indicator", EmitDefaultValue=false)]
        public HealthIndicatorEnum? HealthIndicator { get; set; }
        /// <summary>
        /// The state of the campaign
        /// </summary>
        /// <value>The state of the campaign</value>
        ...
        /// </summary>
        /// <value>Text description of why a campaign failed to start or why a campaign stopped.</value>
        [DataMember(Name="autostop_reason", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>The filter for the devices the campaign is targeting at</value>
        ...
        /// </summary>
        /// <value>The scheduled start time for the campaign. The campaign will start within 1 minute when then start time has elapsed.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AutostopReason: ").Append(AutostopReason).Append("\n");
            sb.Append("  CreatedAt: ").Append(CreatedAt).Append("\n");
            sb.Append("  Description: ").Append(Description).Append("\n");
            sb.Append("  DeviceFilter: ").Append(DeviceFilter).Append("\n");
            sb.Append("  Etag: ").Append(Etag).Append("\n");
            sb.Append("  Finished: ").Append(Finished).Append("\n");
            sb.Append("  HealthIndicator: ").Append(HealthIndicator).Append("\n");
        ...
        public bool Equals(UpdateCampaign input)
        {
            ...
            return 
                (
                    this.AutostopReason == input.AutostopReason ||
                    (this.AutostopReason != null &&
                    this.AutostopReason.Equals(input.AutostopReason))
                ) && 
                (
                ...
                (
                    this.HealthIndicator == input.HealthIndicator ||
                    (this.HealthIndicator != null &&
                    this.HealthIndicator.Equals(input.HealthIndicator))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AutostopReason != null)
                    hashCode = hashCode * 59 + this.AutostopReason.GetHashCode();
                ...
                if (this.HealthIndicator != null)
                    hashCode = hashCode * 59 + this.HealthIndicator.GetHashCode();
                if (this.Id != null)
