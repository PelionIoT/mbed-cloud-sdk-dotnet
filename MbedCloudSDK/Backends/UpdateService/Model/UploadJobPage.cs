...
namespace update_service.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UploadJobPage :  IEquatable<UploadJobPage>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadJobPage" /> class.
        /// </summary>
        ...
        public UploadJobPage(string After = default(string), List<UploadJob> Data = default(List<UploadJob>), bool? HasMore = default(bool?), int? Limit = default(int?), string _Object = default(string), OrderEnum? Order = default(OrderEnum?), int? TotalCount = default(int?))
        {
            this.After = After;
            this.Data = Data;
        ...
        public List<UploadJob> Data { get; set; }
        ...
        {
            return this.Equals(input as UploadJobPage);
        }

        /// <summary>
        /// Returns true if UploadJobPage instances are equal
        /// </summary>
        /// <param name="input">Instance of UploadJobPage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UploadJobPage input)
        {
            if (input == null)
                return false;
