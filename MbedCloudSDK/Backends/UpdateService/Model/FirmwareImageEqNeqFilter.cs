...
namespace update_service.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FirmwareImageEqNeqFilter :  IEquatable<FirmwareImageEqNeqFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FirmwareImageEqNeqFilter" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as FirmwareImageEqNeqFilter);
        }

        /// <summary>
        /// Returns true if FirmwareImageEqNeqFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of FirmwareImageEqNeqFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FirmwareImageEqNeqFilter input)
        {
            if (input == null)
                return false;
