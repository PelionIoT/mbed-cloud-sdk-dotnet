...
namespace update_service.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UploadJob1 :  IEquatable<UploadJob1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadJob1" /> class.
        /// </summary>
        /// <param name="Description">Human-readable description.</param>
        /// <param name="Name">Human-readable name.</param>
        public UploadJob1(string Description = default(string), string Name = default(string))
        {
        ...
        {
            return this.Equals(input as UploadJob1);
        }

        /// <summary>
        /// Returns true if UploadJob1 instances are equal
        /// </summary>
        /// <param name="input">Instance of UploadJob1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UploadJob1 input)
        {
            if (input == null)
                return false;
