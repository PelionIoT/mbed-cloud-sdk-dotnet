...
namespace billing.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AggregatedQuotaUsageReport :  IEquatable<AggregatedQuotaUsageReport>, IValidatableObject
    {
        /// <summary>
        ...
        protected AggregatedQuotaUsageReport() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AggregatedQuotaUsageReport" /> class.
        /// </summary>
        ...
        public AggregatedQuotaUsageReport(string AccountId = default(string), long? Amount = default(long?), string CampaignName = default(string), DateTime? Time = default(DateTime?), TypeEnum? Type = default(TypeEnum?))
        {
            ...
            if (AccountId == null)
            {
                throw new InvalidDataException("AccountId is a required property for AggregatedQuotaUsageReport and cannot be null");
            }
            else
            {
            ...
            if (Amount == null)
            {
                throw new InvalidDataException("Amount is a required property for AggregatedQuotaUsageReport and cannot be null");
            }
            else
            {
                this.Amount = Amount;
            ...
            if (Time == null)
            {
                throw new InvalidDataException("Time is a required property for AggregatedQuotaUsageReport and cannot be null");
            }
            else
            {
                this.Time = Time;
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for AggregatedQuotaUsageReport and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        {
            return this.Equals(input as AggregatedQuotaUsageReport);
        }

        /// <summary>
        /// Returns true if AggregatedQuotaUsageReport instances are equal
        /// </summary>
        /// <param name="input">Instance of AggregatedQuotaUsageReport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AggregatedQuotaUsageReport input)
        {
            if (input == null)
                return false;
