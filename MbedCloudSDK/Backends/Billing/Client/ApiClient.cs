...
namespace billing.Client
{
    ...
    public partial class ApiClient
    {
        ...
        /// with default configuration and base path (http://mbed-billing.example.com).
        /// </summary>
        public ApiClient()
        {
            Configuration = Configuration.Default;
            RestClient = new RestClient("http://mbed-billing.example.com");
            LastApiResponse = new List<IRestResponse>();
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (http://mbed-billing.example.com).
        /// </summary>
        ...
        public ApiClient(String basePath = "http://mbed-billing.example.com")
        {
