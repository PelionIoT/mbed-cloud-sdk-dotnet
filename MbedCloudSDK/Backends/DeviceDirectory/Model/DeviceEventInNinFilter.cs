...
namespace device_directory.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeviceEventInNinFilter :  IEquatable<DeviceEventInNinFilter>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DeviceEventInNinFilter);
        }

        /// <summary>
        /// Returns true if DeviceEventInNinFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceEventInNinFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceEventInNinFilter input)
        {
            if (input == null)
                return false;
