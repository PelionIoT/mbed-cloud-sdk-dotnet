...
namespace MbedCloudSDK.Accounts.User
{
    ...
    public partial class User : BaseModel
    {
        ...
        public PaginatedResponse<QueryOptions, PolicyGroup> Groups(string after = null, string include = null, int? limit = null, string order = null)
        {
            ...
            try
            {
                Func<QueryOptions, ResponsePage<PolicyGroup>> paginatedFunc = (QueryOptions _options) => { return AsyncHelper.RunSync<ResponsePage<PolicyGroup>>(() => MbedCloudSDK.Client.ApiCall.CallApi<ResponsePage<PolicyGroup>>(path: "/v3/accounts/{accountID}/users/{user-id}/groups", method: Method.GET, settings: SerializationSettings.GetSettingsWithRenames(Renames.RenamesDict), accepts: new string[] { "application/json" }, contentTypes: new string[] { "application/json" }, body: data, pathParams: new Dictionary<string, object>() { { "accountID", AccountId }, { "user-id", Id }, }, queryParams: new Dictionary<string, object>() { { "after", after }, { "include", include }, { "limit", limit }, { "order", order }, }, configuration: Config)); };
